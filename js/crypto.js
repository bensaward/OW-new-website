...
function DH_key_exchange(mod, generator, s_result, session)
{
    ...
    var result = (s_result ^ cnonce) % mod; //Our session key
    
    var date_now=new Date();
    date_now.setTime(date_now.getTime()+(2*60*1000)); //2 minutes
    
    var cookie_data="key_secret="+result+"; expires="+date_now.toUTCString()+"; path=/;"
